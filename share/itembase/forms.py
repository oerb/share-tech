...
class LocationForm(forms.Form):
    ...
    lc_geo = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Geo Location'}))
    lc_adr = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'PLZ'}))
    lc_city = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'City'}))
    lc_www = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'www'}))
    lc_mail = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'E-Mail'}))
    lc_info = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Info'}))
...
class ItemForm(forms.Form):
    ...
    it_info = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Item Info'}))
    it_storageinfo = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Item Info'}))
    it_back_to_owner = forms.BooleanField()
    it_back_to_owner.widget.attrs['class'] = 'form-control'
    it_back_to_owner.widget.attrs['placeholder'] = 'back to owner'
    it_personal_handover = forms.BooleanField()
